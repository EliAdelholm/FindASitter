...
export class ConversationComponent implements OnInit, OnDestroy, AfterViewInit {
	conversationId: number = this.route.snapshot.params.conversationId;
	...
	constructor(private route: ActivatedRoute, private ngRedux: NgRedux<IAppState>, private usersActions: UsersActions, private chat: ChatService) { }
